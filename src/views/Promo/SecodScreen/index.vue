		...
		<!--<div class="container">-->
			...
			<!--<div class="content">-->
				...
				<!--<div class="services-list">-->
					<!--<div class="item active" @click="changePromoText">-->
      ...
      servicesArray: [
        {
          ...
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»1',
        },
        {
          id: 2,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»2',
        },
        {
          id: 3,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»3',
        },
        {
          id: 4,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»4',
        },
        {
          id: 5,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»5',
        },
        {
          id: 6,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»6',
        },
        {
          id: 7,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»7',
        },
        {
          id: 8,
          icon: '/features/autorenewal.svg',
          name: 'Поддержка DNS',
          text: 'Для любого вашего домена, зарегистрированного на «Джино»8',
        },
      ],
